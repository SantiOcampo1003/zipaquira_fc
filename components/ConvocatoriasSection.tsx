      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <RevealOnScroll className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base lg:text-lg">
            {convocatoriaReopenMessage} {clubName} convoca a jugadores en sus tres ramas: Sub-20, Equipo de Reserva y Primer Equipo.
          </p>
        ...
        <div className="mt-10 grid gap-4 sm:mt-12 lg:grid-cols-2">
          {convocatoriaCalls.map((call, i) => (
            <RevealOnScroll key={call.id} delay={0.05 * i}>
              <article className="flex h-full flex-col justify-between rounded-2xl border border-primary/25 bg-[#18181B]/80 p-5 ring-1 ring-primary/10 sm:p-6">
                <div>
                ...
                <div className="mt-6">
                  <a
                    ...
                    className={cn(
                      buttonVariants({ variant: i === 0 ? "default" : "secondary" }),
                      "h-12 w-full gap-2 px-6 text-xs font-semibold uppercase tracking-wide sm:text-sm inline-flex items-center justify-center",
                      i === 0
                        ? "bg-primary text-primary-foreground hover:bg-primary/90"
                        : "border border-primary/35 bg-primary/10 text-primary hover:bg-primary/20"
                    )}
                  >
        ...
        <RevealOnScroll className="mt-12 sm:mt-16">
          <div className="text-center">
            <h3 className="font-heading text-lg font-normal uppercase tracking-wide text-white sm:text-xl">
          ...
          <div className="rounded-2xl border border-primary/25 bg-rz-forest/30 p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-8 flex justify-center">
              <ConvocatoriaCtas
                ...
                primaryButtonClassName="bg-primary text-primary-foreground shadow-[0_0_40px_-8px_rgba(169,146,89,0.45)] hover:bg-primary/90"
                secondaryButtonClassName="border border-primary/35 bg-primary/10 text-primary hover:bg-primary/20"
              />
            </div>
            <p className="mt-4 text-center text-xs text-muted-foreground">
              Ambos botones abren el formulario oficial de inscripción en una nueva pestaña.
            </p>
          </div>
        </RevealOnScroll>
      </div>
